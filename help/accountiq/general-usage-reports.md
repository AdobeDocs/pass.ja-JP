...
履歴表示の棒グラフは、様々な時間間隔での使用状況指標を比較するのに役立ちます。 また、[ アカウントあたりの週あたり（または月あたり）、[ アカウントあたりの週あたり（または月あたり）の場所 ](#devices-week-account)、[ アカウントあたりの週あたり（または月あたり）の IP](#locations-week-account) など、様々な使用指標をまとめてプロットし ](#ip-week-account) す。
