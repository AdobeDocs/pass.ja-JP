---
title: 同時実行性モニタリングでVODとライブコンテンツを区別する方法
description: 同時実行性モニタリングでVODとライブコンテンツを区別する方法
...
# 同時実行性モニタリングでVODとライブコンテンツを区別する方法 {#dist-vod-live}
...
* [標準メタデータ属性の同時監視](/help/concurrency-monitoring/technical/standard-metadata-attributes.md)
* [同時実行の監視 API の概要](/help/concurrency-monitoring/api/cm-api-overview.md)
