...
[API v2.0](http://docs.adobeptime.io/cm-api-v2/) では、定義されたポリシーでこれらの属性のいずれかが必要な場合、その属性を持たないセッションの init 試行は 400 Bad Request になります。
...
* [API コンソール - Adobe同時実行性の監視 ](http://docs.adobeptime.io/cm-api-v2/)
