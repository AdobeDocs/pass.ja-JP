...
>
> * [ クライアント資格情報の取得 ](/help/authentication/integration-guide-programmers/rest-apis/rest-api-dcr/apis/dynamic-client-registration-apis-retrieve-client-credentials.md) API ドキュメントの説明に従って、クライアント資格情報を取得します。
...
### プログラマーが使用できるディメンション {#progr-dimensions}
...
| 405 | 許可されていないメソッド | サポートされていないメソッドがリクエストで使用されたことを示します。 現在はGETの方法のみがサポートされていますが、今後のバージョンでは、HEADまたはOPTIONSが許可される可能性があります |
