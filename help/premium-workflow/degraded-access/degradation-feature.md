...
この機能は、[&#x200B; 使用状況モニタリング API](/help/premium-workflow/esm/entitlement-service-monitoring-overview.md) と組み合わせて使用するように設計されており、MVPD との事前契約に基づいて、Adobe Pass認証は、重要な瞬間にユーザーエクスペリエンス、信頼性、運用制御のバランスを取る強力なツールを提供します。
