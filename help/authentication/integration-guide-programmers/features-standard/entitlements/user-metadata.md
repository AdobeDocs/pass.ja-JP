...
ユーザーメタデータの属性を暗号化および復号化するには、プログラマーが証明書（公開鍵と秘密鍵のペア）を生成し、&lbrace;2[Adobe Pass TVE ダッシュボードを使用して証明書を &#x200B;](#management) 自己設定 [&#x200B; するか、公開鍵をAdobe Pass認証担当者と共有する必要があります。](https://experience.adobe.com/#/pass/authentication)
