...
### &#x200B;3. 有効なプロファイルが既に存在する場合は、認証セッションを再開します
...
### &#x200B;4. 基本またはプロモーションの TempPass を使用して認証セッションを再開します（必須ではありません）
