...
* REST API v2`partner_logout`Logout API`partner_interactive` 応答で通常のログアウトとパートナースシングルサインオンログアウトを区別する新しい [ アクション名と ](/help/authentication/integration-guide-programmers/rest-apis/rest-api-v2/apis/logout-apis/rest-api-v2-logout-apis-initiate-logout-for-specific-mvpd.md) アクションタイプ。
* REST API v2 `reason` セッション API[ および ](/help/authentication/integration-guide-programmers/rest-apis/rest-api-v2/apis/sessions-apis/rest-api-v2-sessions-apis-create-authentication-session.md) セッション SSO API[ 応答のアクション名に関するより多くのインサイトを提供する新しい ](/help/authentication/integration-guide-programmers/rest-apis/rest-api-v2/apis/partner-single-sign-on-apis/rest-api-v2-partner-single-sign-on-apis-retrieve-partner-authentication-request.md) フィールド。
...
* REST API v2 `notBefore`Profiles API[ 応答のユーザープロファイルのタイムスタンプ ](/help/authentication/integration-guide-programmers/rest-apis/rest-api-v2/apis/profiles-apis/rest-api-v2-profiles-apis-retrieve-profiles.md) 誤って計算される問題を修正しました。
