...
明確にする項目は、[MVPD 統合機能 ](/help/authentication/integration-guide-mvpds/mvpd-integr-features.md) を参照してください。
...
Adobeの環境の使用方法について詳しくは、「[Adobe環境について ](/help/authentication/notes-technical/understanding-the-adobe-environments.md) を参照してください。
...
このフェーズでは、Adobeと MVPD は、統合のテストとトラブルシューティングを行います。 Adobeのテストに役立てるため、Adobe Pass認証チームは、統合の API テストサイトを使用できます。 Adobeの API テストサイトの使用について詳しくは、[AdobeAPI テストサイトを使用した認証および承認フローのテスト ](/help/authentication/notes-technical/test-authn-authz-flows-using-adobes-api-test-site.md) を参照してください。
