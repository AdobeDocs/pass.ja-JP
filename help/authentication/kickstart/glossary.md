...
プログラマーのアプリのユーザーを一意に識別しますが、MVPD から開始します。 様々なユースケース向けに、様々なフォームで使用できます。 [ プログラマの概要のユーザー ID について ](/help/authentication/kickstart/programmer-overview.md#user-ids) を参照してください。
