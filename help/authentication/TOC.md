...
- 製品リリース {#product-releases}
  - 2026 {#2026}
    - {hide-from-toc}[Adobe Pass Authentication 3.9.0 リリースノート &#x200B;](notes-releases/auth-rn-390.md)
    - [Adobe Pass Authentication 3.8.0 リリースノート](notes-releases/auth-rn-380.md)
