...
![ 既存のチャネルのリスト ](/help/authentication/assets/tve-dashboard/new-tve-dashboard/channels/channels-list-view.png)
...
1. 次のいずれかのタブを選択して、選択したチャネルの対応する設定を表示および編集します。
   ...
   * [カスタムスキーム](#custom-schemes)
   ...
   ![ チャネル設定 ](/help/authentication/assets/tve-dashboard/new-tve-dashboard/channels/channel-tabs-view.png)
...
![ チャネル情報の編集 ](/help/authentication/assets/tve-dashboard/new-tve-dashboard/channels/channel-general-settings-tab-view.png)
...
![Analytics 設定の有効化 ](/help/authentication/assets/tve-dashboard/new-tve-dashboard/channels/channel-add-new-analytics-configuration-button.png)
...
![ 使用可能な統合のリスト ](/help/authentication/assets/tve-dashboard/new-tve-dashboard/channels/channel-integrations-tab-view.png)
...
1. **利用可能な証明書** セクションの上部にある **新しい証明書を追加** を選択します。
   ...
   ![ 新しい証明書を追加する ](/help/authentication/assets/tve-dashboard/new-tve-dashboard/channels/channel-add-new-certificate-button.png)
...
1. 「**削除**」を選択します。
   ...
   ![ 選択した証明書を削除する ](/help/authentication/assets/tve-dashboard/new-tve-dashboard/channels/channel-delete-certificate-button.png)
...
![ 継承された使用可能な証明書 ](/help/authentication/assets/tve-dashboard/new-tve-dashboard/channels/channel-inherited-available-certificates-panel-view.png)
...
1. **使用可能なドメイン** セクションの右上隅にある **新しいドメインを追加** を選択します。
   ...
   ![ 新しいドメインを追加 ](/help/authentication/assets/tve-dashboard/new-tve-dashboard/channels/channel-add-new-domain-button.png)
...
1. 「**削除**」を選択します。
   ...
   ![ 選択したドメインを削除 ](/help/authentication/assets/tve-dashboard/new-tve-dashboard/channels/channel-remove-domain-button.png)
...
1. **登録済みアプリケーション** セクションの右上隅にある **新しいアプリケーションを追加** を選択します。
   ...
   ![ 新しいアプリケーションの追加 ](/help/authentication/assets/tve-dashboard/new-tve-dashboard/channels/channel-add-new-application-button.png)
...
1. 「**ダウンロード**」を選択します。
   ...
   ![ ソフトウェアに関する声明のダウンロード ](/help/authentication/assets/tve-dashboard/new-tve-dashboard/channels/channel-download-software-statement-button.png)
...
1. **新しいカスタムスキームを生成** を選択します。
   ...
   ![ 新しいカスタムスキームの生成 ](/help/authentication/assets/tve-dashboard/new-tve-dashboard/channels/channel-add-new-custom-scheme-button.png)
...
![ 継承されたカスタム スキーマ ](/help/authentication/assets/tve-dashboard/new-tve-dashboard/channels/channel-inherited-custom-schemes-panel-view.png)
...
1. **チャネル** セクションの右上隅にある **新しいチャネルを追加** を選択します。
   ...
   ![ 新しいチャネルを追加 ](/help/authentication/assets/tve-dashboard/new-tve-dashboard/channels/channel-add-new-channel-button.png)
